...
public class RPSLSpockTest {
    ...
    public void isValidPick() {
        ...
        Assert.assertFalse(! RPSLSpock.isValidPick(RPSLSpock.LIZARD)||
                                    ! RPSLSpock.isValidPick(RPSLSpock.SPOCK)||
                                    ! RPSLSpock.isValidPick(RPSLSpock.ROCK)||
                                    ! RPSLSpock.isValidPick(RPSLSpock.PAPER)||
                                    ! RPSLSpock.isValidPick(RPSLSpock.SCISSORS));
    }
